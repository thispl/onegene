...
def get_columns():
	columns = [
		_("Employee ID") + ":Data:100",_("Employee Name") + ":Data:200",_("Department") + ":Data:200",_("Designation") + ":Data:200",_("Employee Category") + ":Data:150",_("OT") + ":Data:150",_("Comp-off used") + ":Data:100",
    ...
    if filters.from_date and filters.to_date:
        ...
        otbalance = frappe.get_all(
            ...
            fields=[
                ...
                "sum(comp_off_used)*8 as comp_off_used",
